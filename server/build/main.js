...
/* harmony import */ var _team__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./team */ "./src/team/index.js");
...
protectedApiRouter.use('/team', _team__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/team/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/team/store.js");
...
router.get('/:id', async ctx => {
  const userId = ctx.state.user._id;
  const team = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createTeam = async (ctx, team, response) => {
  try {
    const userId = ctx.state.user._id;
    team.userId = userId;
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(team);
    response.status = 201; // created
...
/*!***************************!*\
  !*** ./src/team/store.js ***!
  \***************************/
/*! exports provided: TeamStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (new TeamStore({
  filename: './db/teams.json',
  autoload: true
}));
...
module.exports = __webpack_require__(/*! D:\ionic\server\src/index.js */"./src/index.js");
